...
export default function signin() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto font-bold'>
      <h1 className='text-3xl text-center my-7 mt-20'>Sign In</h1>
      <form className='flex flex-col gap-5 justify-center p-12 border rounded-md bg-white shadow-lg' onSubmit={handleSubmit}>
        ...
        <button disabled={loading} className='border rounded-lg p-2 bg-blue-700 text-white shadow-md'>{loading ? 'Loading...':'Sign In'}</button>
      </form>
